        ...
        findViewById(R.id.btnUpload).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                uploadTask.addOnFailureListener(exception -> {
                    Toast.makeText(FirebaseActivity.this, "TASK FAILED", Toast.LENGTH_SHORT).show();
                }).addOnSuccessListener(taskSnapshot -> {
                    Toast.makeText(FirebaseActivity.this, "TASK SUCCEEDED", Toast.LENGTH_SHORT).show();

                    String DOWNLOAD_URL = taskSnapshot.getMetadata().getReference().getDownloadUrl().toString();
                    Log.v("DOWNLOAD URL", DOWNLOAD_URL);
                    Toast.makeText(FirebaseActivity.this, DOWNLOAD_URL, Toast.LENGTH_SHORT).show();
                });
            }
        });
